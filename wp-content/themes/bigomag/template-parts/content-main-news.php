    ...
    <section class="site_newsblock" style="margin: 0px 0px 30px 0px">
        ...
        <?php while ($catquery->have_posts()) : $catquery->the_post(); ?>
            ...
            <div class="news_title">
                <h2><a href="<?php echo get_term_link(307); ?>"> मुख्य समाचार </a></h2>
                ...
                <div class="col-md-12">
                    <div class="column_block clearfix"> <?php if (has_post_thumbnail($post->ID)): ?>
                        <a href="<?php echo get_permalink(); ?>">
                            <div class="col-md-6 mainnews"><?php $image = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'full', false);
                            $image_src = $image[0];
                            echo '<img src="' . $image_src . '" alt="' . get_the_title() . '">'; ?></div>
                            </a><?php endif; ?>
                        <h3 class="mainnewstitle"><a href="<?php echo get_permalink(); ?>"><?php the_title(); ?> </a></h3>
                        <p class="the-excerpt"><?php echo wp_trim_words(get_the_excerpt(),'26',null);?></p>
                        <div class="clearfix"></div>
                    </div>
                </div>
                <?php
        ...
        <div class="col-md-3 no-img-news" style="border-left: 2px solid #f2f2f2;">
                    <?php $args = array(
                        'post_type' => 'post',
                        'posts_per_page' => '6',
                        'offset' => '5',
